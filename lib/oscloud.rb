...
### Euca     Functions ###
  ...
  def authorizedsecuritygroupingress
    ...
    @parameters['IpProtocol']=@therule.protocol
    @parameters['FromPort']=@therule.port
    @parameters['ToPort']=@therule.port
  ...
  def revokesecuritygroupingress
    ...
    @parameters['FromPort']=@therule.port
    @parameters['ToPort']=@therule.port
    @parameters['CirdIp']=@therule.source
    q = createSign(@parameters, @thezone.entrypoint)
    r = queryCloud(q, @thezone.entrypoint)
    parseQuery("return",r)
  end
  ...
  def runinstances
    ...
    @parameters['KeyName']=@thekey.name
    @parameters['SecurityGroup.1']=@thefirewall.name
